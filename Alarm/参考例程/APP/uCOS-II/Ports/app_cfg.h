...
/*******************设置任务优先级*******************/
#define APP_ADC_MUTEX_PRIO                7
#define RES_PUBLIC_STK_MUTEX_PRIO         9
#define RES_FILE_MUTEX_PRIO               11

#define APP_STARTUP_TASK_PRIO             21
#define APP_UART1_TASK_PRIO               23
#define APP_LED1_TASK_PRIO                25



/************设置栈大小（单位为 OS_STK ）************/  
#define APP_STARTUP_TASK_STK_SIZE         512
#define APP_LED1_TASK_STK_SIZE            512
